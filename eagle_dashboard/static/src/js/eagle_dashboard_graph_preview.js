                    ...
                    },
                    {
                        ...
                        ticks: {
                            ...
                            callback : function(value, index, values){
                                var eagle_selection = self.chart_data.eagle_selection;
                                if (eagle_selection === 'monetary'){
                                    var eagle_currency_id = self.chart_data.eagle_currency;
                                    ...
                                    var eagle_field = self.chart_data.eagle_field;
            ...
            if (ksChartFamily == "circle") {
                ...
                options.tooltips.callbacks = {
                                               title: function(tooltipItem, data) {
                                                    ...
                                                    var eagle_selection = eagle_self.chart_data.eagle_selection;
                                                    if (eagle_selection === 'monetary'){
                                                        var eagle_currency_id = eagle_self.chart_data.eagle_currency;
                                                        ...
                                                        var eagle_field = eagle_self.chart_data.eagle_field;
