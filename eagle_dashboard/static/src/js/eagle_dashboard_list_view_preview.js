eagle.define('eagle_dashboard_list.eagle_dashboard_list_view_preview', function (require) {
    ...
    var KsListViewPreview = AbstractField.extend({
        ...
        ksRenderListView: function () {
            ...
            var count = field.eagle_record_count;
            ...
            count = list_view_data && field.eagle_list_view_type === "ungrouped" ? count - list_view_data.data_rows.length : false;
            ...
            if (!this.recordData.eagle_show_records === true) {
                $listViewContainer.find('#eagle_item_info').hide();
            }
