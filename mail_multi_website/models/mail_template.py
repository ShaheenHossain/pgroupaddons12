...
import logging
from eagle import models, fields, api, tools, _
from eagle.exceptions import UserError
from eagle.tools import pycompat
from eagle.addons.mail.models.mail_template import format_date, format_tz, format_amount

_logger = logging.getLogger(__name__)
FIELDS = ['body_html', 'mail_server_id', 'report_template']

try:
    from eagle.addons.mail.models.mail_template import mako_safe_template_env, mako_template_env
except ImportError:
